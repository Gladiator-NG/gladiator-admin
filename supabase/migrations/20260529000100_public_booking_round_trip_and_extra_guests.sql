-- Align public website bookings with the admin booking model:
-- - boat_rental round trips use end_date/end_time as the return pickup.
-- - beach house extra guests are allowed when an extra guest fee is configured.
