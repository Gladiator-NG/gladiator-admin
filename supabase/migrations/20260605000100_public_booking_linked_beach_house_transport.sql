-- Allow public boat-transfer bookings to link to an existing beach house
-- booking by reference code. The link is stored as parent_beach_house_booking_id
-- after validating that the reference belongs to a beach_house booking.
